...
if [[ "$1 $2" == "clear cache" || "$1" == "ecc" ]]; then
   ...
   usage="[95mclear cache [96m(ecc)[97m [37m[<index_name>][97m[0m "
...
if [[ "$1 $2" == "cluster overview" || "$1" == "eco" ]]; then
   ...
   usage="[95mcluster overview [96m(eco)[97m[0m "
   check_params $# 0 "Usage: $usage"
...
if [[ "$1 $2" == "cluster health" || "$1" == "ech" ]]; then
   ...
   usage="[95mcluster health [96m(ech)[97m[0m "
   check_params $# 0 "Usage: $usage"
...
if [[ "$1 $2" == "cluster stats" || "$1" == "ecs" ]]; then
   ...
   usage="[95mcluster stats [96m(ecs)[97m[0m "
   check_params $# 0 "Usage: $usage"
...
if [[ "$1" == "count" || "$1" == "ec" ]]; then
   ...
   usage="[95mcount [96m(ec)[97m <index_name>[0m "
...
if [[ "$1 $2" == "list aliases" || "$1" == "ela" ]]; then
   ...
   usage="[95mlist aliases [96m(ela)[97m [37m[<filter>][97m [37m[<order_by_field_name>][97m[0m "
   check_params $# 0 "Usage: $usage"
...
if [[ "$1 $2" == "list indices" || "$1" == "eli" ]]; then
   ...
   usage="[95mlist indices [96m(eli)[97m [37m[<index_name>][97m[0m "
   check_params $# 0 "Usage: $usage"
...
if [[ "$1 $2" == "list shards" || "$1" == "els" ]]; then
   ...
   usage="[95mlist shards [96m(els)[97m [37m[<index_name>][97m [37m[<order_by_field_name>][97m[0m "
   check_params $# 0 "Usage: $usage"
...
if [[ "$1 $2 $3" == "list shard details" || "$1" == "elsd" ]]; then
   ...
   usage="[95mlist shard details [96m(elsd)[97m [37m[<index_name>][97m [37m[<order_by_field_name>][97m[0m "
   check_params $# 0 "Usage: $usage"
...
if [[ "$1 $2" == "list segments" || "$1" == "ele" ]]; then
   ...
   usage="[95mlist segments [96m(ele)[97m [37m[<index_name>][97m[0m "
   check_params $# 0 "Usage: $usage"
...
if [[ "$1 $2 $3" == "list segmented shards" || "$1" == "elss" ]]; then
   ...
   usage="[95mlist segmented shards [96m(elss)[97m [37m[<index_name>][97m[0m "
   check_params $# 0 "Usage: $usage"
...
if [[ "$1 $2 $3" == "get index mapping" || "$1" == "egim" ]]; then
   ...
   usage="[95mget index mapping [96m(egim)[97m <index_name>[0m "
   check_params $# 1 "Usage: $usage"
...
if [[ "$1 $2 $3" == "list unassigned shards" || "$1" == "elus" ]]; then
   ...
   usage="[95mlist unassigned shards [96m(elus)[97m[0m "
   check_params $# 0 "Usage: $usage"
...
if [[ "$1 $2" == "forcemerge progress" || "$1" == "efmp" ]]; then
   ...
   usage="[95mforcemerge progress [96m(efmp)[97m[0m "
   check_params $# 0 "Usage: $usage"
...
if [[ "$1 $2 $3 $4" == "add index to alias" || "$1" == "eaita" ]]; then
   ...
   usage="[95madd index to alias [96m(eaita)[97m <index_name> <alias_name>[0m "
...
if [[ "$1 $2 $3 $4" == "remove index from alias" || "$1" == "erifa" ]]; then
   ...
   usage="[95mremove index from alias [96m(erifa)[97m <index_name> <alias_name>[0m "
   check_params $# 2 "Usage: $usage"
...
if [[ "$1 $2" == "create index" || "$1" == "eci" ]]; then
   ...
   usage="[95mcreate index [96m(eci)[97m <index_name> <number_of_shards> <number_of_replicas>[0m "
...
if [[ "$1 $2 $3 $4" == "create index from mapping" || "$1" == "ecifm" ]]; then
   ...
   usage="[95mcreate index from mapping [96m(ecifm)[97m <index_name> <number_of_shards> <number_of_replicas> <mapping-json>[0m "
...
if [[ "$1 $2" == "clone index" || "$1" == "eclni" ]]; then
   ...
   usage="[95mclone index [96m(eclni)[97m <index_name> <new_index_name>[0m "
   check_params $# 2 "Usage: $usage"
...
if [[ "$1 $2" == "delete index" || "$1" == "edi" ]]; then
   ...
   usage="[95mdelete index [96m(edi)[97m <index_name>[0m "
   check_params $# 1 "Usage: $usage"
...
if [[ "$1 $2" == "open index" || "$1" == "eopi" ]]; then
   ...
   usage="[95mopen index [96m(eopi)[97m <index_name>[0m "
   check_params $# 1 "Usage: $usage"
...
if [[ "$1 $2" == "close index" || "$1" == "ecli" ]]; then
   ...
   usage="[95mclose index [96m(ecli)[97m <index_name>[0m "
   check_params $# 1 "Usage: $usage"
...
if [[ "$1 $2 $3" == "enable read only" || "$1" == "eero" ]]; then
   ...
   usage="[95menable read only [96m(eero)[97m <index_name>[0m "
   check_params $# 1 "Usage: $usage"
...
if [[ "$1 $2 $3" == "enable read write" || "$1" == "eerw" ]]; then
   ...
   usage="[95menable read write [96m(eerw)[97m <index_name>[0m "
   check_params $# 1 "Usage: $usage"
...
if [[ "$1 $2" == "reindex index" || "$1" == "eri" ]]; then
   ...
   usage="[95mreindex index [96m(eri)[97m <source_index_name> <dest_index_name>[0m "
   check_params $# 2 "Usage: $usage"
...
if [[ "$1 $2" == "move shard" || "$1" == "ems" ]]; then
   ...
   usage="[95mmove shard [96m(ems)[97m <index_name> <shard_num> <from_node_name> <to_node_name>[0m "
   check_params $# 4 "Usage: $usage"
...
if [[ "$1 $2 $3" == "alter number replicas" || "$1" == "eanr" ]]; then
   ...
   usage="[95malter number replicas [96m(eanr)[97m <index_name> <number_of_replicas>[0m "
   check_params $# 2 "Usage: $usage"
...
if [[ "$1 $2 $3" == "disable shard allocation" || "$1" == "edsa" ]]; then
   ...
   usage="[95mdisable shard allocation [96m(edsa)[97m[0m "
   check_params $# 0 "Usage: $usage"
...
if [[ "$1 $2 $3" == "reenable shard allocation" || "$1" == "ersa" ]]; then
   ...
   usage="[95mreenable shard allocation [96m(ersa)[97m[0m "
   check_params $# 0 "Usage: $usage"
...
if [[ "$1" == "forcemerge" || "$1" == "efm" ]]; then
   ...
   usage="[95mforcemerge [96m(efm)[97m <index_name> <max_num_segments>[0m "
   check_params $# 2 "Usage: $usage"
...
if [[ "$1" == "refresh" || "$1" == "er" ]]; then
   ...
   usage="[95mrefresh [96m(er)[97m <index_name>[0m "
   check_params $# 1 "Usage: $usage"
...
if [[ "$1 $2" == "add entry" || "$1" == "eae" ]]; then
   ...
   usage="[95madd entry [96m(eae)[97m <index_name> <entry_json>[0m "
   check_params $# 2 "Usage: $usage"
...
if [[ "$1 $2" == "list nodes" || "$1" == "eln" ]]; then
   ...
   usage="[95mlist nodes [96m(eln)[97m[0m "
   check_params $# 0 "Usage: $usage"
...
if [[ "$1 $2 $3" == "list nodes queries" || "$1" == "elnq" ]]; then
   ...
   usage="[95mlist nodes queries [96m(elnq)[97m[0m "
   check_params $# 0 "Usage: $usage"
...
if [[ "$1 $2" == "search nodes" || "$1" == "esn" ]]; then
   ...
   usage="[95msearch nodes [96m(esn)[97m[0m "
   check_params $# 0 "Usage: $usage"
...
if [[ "$1 $2 $3" == "node active threads" || "$1" == "eat" ]]; then
   ...
   usage="[95mnode active threads [96m(eat)[97m[0m "
   check_params $# 0 "Usage: $usage"
...
if [[ "$1" == "search" || "$1" == "es" ]]; then
   ...
   usage="[95msearch [96m(es)[97m <index_name> <search_term>[0m "
   check_params $# 2 "Usage: $usage"
...
if [[ "$1 $2" == "search json" || "$1" == "esj" ]]; then
   ...
   usage="[95msearch json [96m(esj)[97m <index_name> <search_json>[0m "
   check_params $# 2 "Usage: $usage"
...
if [[ "$1 $2" == "search match" || "$1" == "esm" ]]; then
   ...
   usage="[95msearch match [96m(esm)[97m <index_name> <field_name> <value>[0m "
   check_params $# 3 "Usage: $usage"
...
if [[ "$1 $2" == "search term" || "$1" == "est" ]]; then
   ...
   usage="[95msearch term [96m(est)[97m <index_name> <field_name> <value>[0m "
   check_params $# 3 "Usage: $usage"
...
if [[ "$1 $2" == "search summary" || "$1" == "ess" ]]; then
   ...
   usage="[95msearch summary [96m(ess)[97m <index_name> <search_term>[0m "
   check_params $# 2 "Usage: $usage"
...
if [[ "$1" == "sql" || "$1" == "esql" ]]; then
   if [[ "$1" == "esql" ]]; then shift; else shift 1; fi
   usage="[95msql [96m(esql)[97m <sql>[0m "
   check_params $# 1 "Usage: $usage"
   print_command " echo '{\"query\": \"'\"${1//\\"/\\\\"}\"'\"}'; curl -X POST \"http://$ES_HOST:$ES_PORT/_sql?format=json\" -H 'Content-Type: application/json' -d '{\"query\": \"'\"${1//\\"/\\\\"}\"'\"}' | jq "
   echo '{"query": "'"${1//\"/\\\"}"'"}'; curl -X POST "http://$ES_HOST:$ES_PORT/_sql?format=json" -H 'Content-Type: application/json' -d '{"query": "'"${1//\"/\\\"}"'"}' | jq
   exit
fi
section="TASKS"
if [[ "$1 $2" == "list tasks" || "$1" == "elt" ]]; then
   if [[ "$1" == "elt" ]]; then shift; else shift 2; fi
   usage="[95mlist tasks [96m(elt)[97m [37m[<sort_field>][97m[0m "
   check_params $# 0 "Usage: $usage"
...
if [[ "$1 $2 $3" == "list tasks detail" || "$1" == "eltd" ]]; then
   ...
   usage="[95mlist tasks detail [96m(eltd)[97m [37m[<sort_field>][97m[0m "
   check_params $# 0 "Usage: $usage"
...
if [[ "$1 $2" == "add repo" || "$1" == "eare" ]]; then
   ...
   usage="[95madd repo [96m(eare)[97m <repo_name>[0m "
   check_params $# 1 "Usage: $usage"
...
if [[ "$1 $2" == "delete repo" || "$1" == "edre" ]]; then
   ...
   usage="[95mdelete repo [96m(edre)[97m <repo_name>[0m "
   check_params $# 1 "Usage: $usage"
...
if [[ "$1 $2" == "list repos" || "$1" == "elre" ]]; then
   ...
   usage="[95mlist repos [96m(elre)[97m[0m "
   check_params $# 0 "Usage: $usage"
...
if [[ "$1 $2" == "create snapshot" || "$1" == "ecsn" ]]; then
   ...
   usage="[95mcreate snapshot [96m(ecsn)[97m <repo_name> <snapshot_name>[0m "
   check_params $# 2 "Usage: $usage"
...
if [[ "$1 $2" == "delete snapshot" || "$1" == "edsn" ]]; then
   ...
   usage="[95mdelete snapshot [96m(edsn)[97m <repo_name> <snapshot_name>[0m "
   check_params $# 2 "Usage: $usage"
...
if [[ "$1 $2" == "list snapshots" || "$1" == "elsn" ]]; then
   ...
   usage="[95mlist snapshots [96m(elsn)[97m[0m "
   check_params $# 0 "Usage: $usage"
...
if [[ "$1 $2" == "snapshot details" || "$1" == "esnd" ]]; then
   ...
   usage="[95msnapshot details [96m(esnd)[97m <repo_name> <snapshot_name>[0m "
   check_params $# 2 "Usage: $usage"
...
if [[ "$1 $2" == "restore snaphot" || "$1" == "ersn" ]]; then
   ...
   usage="[95mrestore snaphot [96m(ersn)[97m <repo_name> <snapshot_name>[0m "
   check_params $# 2 "Usage: $usage"
...
if [[ "$1" == "generic" || "$1" == "eg" ]]; then
   ...
   usage="[95mgeneric [96m(eg)[97m <type-GET/POST/PUT> <api_call>[0m "
   check_params $# 2 "Usage: $usage"
...
if [[ "$1 $2" == "query-es settings" || "$1" == "eqes" ]]; then
   ...
   usage="[95mquery-es settings [96m(eqes)[97m[0m "
   check_params $# 0 "Usage: $usage"
